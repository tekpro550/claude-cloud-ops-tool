...
import { EventEntity, NotificationEntity, ResourceEntity, TenantEntity, UserEntity } from "./entities";
  ...
  imports: [
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
        ...
        password: config.get<string>("DB_APP_PASSWORD", "app_user_dev_password"),
